  ...
  let A,
    ...
    ee = (e, t) => {
      if (t) {
        ...
        if (s.size) for (; --i > -1;) {
          c = e[i];
          for (n of s) if (n.startsWith(c) && n.length > c.length) {
    ...
    ie = (e, t, s, i, o, c, n, a, h, b) => {
      ...
      let g = Array.from(e.childNodes),
        ...
        k,
        N;
      for (typeof R == "object" ? (H = R.delimiter || R, f = R.replaceWith || "") : f = R === "" ? "" : R || " ", r = f !== " "; C < g.length; C++) if (l = g[C], l.nodeType === 3) {
...
` && ((x = l.previousSibling) == null || x.remove(), z(document.createElement("br"), e, l), p = p.slice(1)), !L && p === "") z(f, e, l);else if (p === " ") e.insertBefore(document.createTextNode(" "), l);else {
          if (r && p.charAt(0) === " " && z(" ", e, l), E && u === 1 && !I && v.indexOf(E.parentNode) > -1 ? (y = v[v.length - 1], y.appendChild(document.createTextNode(i ? "" : p))) : (y = s(i ? "" : p), z(y, e, l), E && u === 1 && !I && y.insertBefore(E, y.firstChild)), i) for (S = V ? ee([...V.segment(p)].map(M => M.segment), h) : p.match(a) || J, N = 0; N < S.length; N++) y.appendChild(S[N] === " " ? document.createTextNode(" ") : i(S[N]));
          if (c && b) {
  ...
  const ne = class se {
    ...
    split(t) {
      ...
      return (g || C || x) && (this.elements.forEach((r, f) => {
        ...
        if (!C) {
          for (d = 0; d < l.length; d++) if (u = l[d], g || !u.nextSibling || u.nextSibling.nodeType !== 3) {
            if (c && !x) {

...
!function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      var w = (a === o ? -1 : 1) * U(C),
        ...
        T = (-m - x) / i,
        R = k * k + D * D,
        N = (D < 0 ? -1 : 1) * Math.acos(k / U(R)),
        L = (k * T - D * H < 0 ? -1 : 1) * Math.acos((k * H + D * T) / U(R * (H * H + T * T)));
      ...
      var B,
        ...
        V = d * -i,
        j = c * i;
      for (B = 0; B < X; B++) _ = W(s = N + B * I), m = F(s), k = W(s += I), D = F(s), O.push(_ - G * m, m + G * _, k + G * D, D - G * k, k, D);
      for (B = 0; B < O.length; B += 2) _ = O[B], m = O[B + 1], O[B] = _ * q + m * V + E, O[B + 1] = _ * z + m * j + M;
  ...
  function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
    var d,
      ...
      x = Q((n - o) * S - (i - r) * w),
      E = Q((s - o) * S - (a - r) * w);
    return l || (l = [t, e, o, r], c = 2), l.splice(c || l.length - 2, 0, A, C), h * (w * w + S * S) < (x + E) * (x + E) && (d = l.length, bezierToPoints(t, e, u, p, v, b, A, C, h, l, c), bezierToPoints(A, C, y, P, _, m, o, r, h, l, c + 2 + (l.length - d))), l;
  }
  function pointsToSegment(t, e) {
    ...
    var i,
      ...
      C = y - v,
      w = P - b,
      S = Math.abs(t[m] - v) < .001 && Math.abs(t[m + 1] - b) < .001;
    for (S && (t.push(y, P), y = v, P = b, v = t[m - 2], b = t[m - 1], t.unshift(v, b), m += 4), e = e || 0 === e ? +e : 1, a = 2; a < m; a += 2) i = v, s = b, v = y, b = P, y = +t[a + 2], P = +t[a + 3], v === y && b === P || (o = C, r = w, C = y - v, w = P - b, c = ((h = U(o * o + r * r)) + (l = U(C * C + w * w))) * e * .25 / U(Math.pow(C / l + o / h, 2) + Math.pow(w / l + r / h, 2)), p = v - ((d = v - (v - i) * (h ? c / h : 0)) + (((u = v + (y - v) * (l ? c / l : 0)) - d) * (3 * h / (h + l) + .5) / 4 || 0)), _ = b - ((g = b - (b - s) * (h ? c / h : 0)) + (((f = b + (P - b) * (l ? c / l : 0)) - g) * (3 * h / (h + l) + .5) / 4 || 0)), v === i && b === s || A.push(n(d + p), n(g + _), n(v), n(b), n(u + p), n(f + _)));
  ...
  function B(t) {
    ...
    !(x in t.style) && "msTransform" in t.style && (E = (x = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode););
    if (g = window, b = new T(), e) {
      f = (p = e).documentElement, _ = e.body, (y = p.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none";
      var n = e.createElement("div"),
        i = e.createElement("div"),
        s = e && (e.body || e.firstElementChild);
      s && s.appendChild && (s.appendChild(n), n.appendChild(i), n.setAttribute("style", "position:static;transform:translate3d(0,0,1px)"), S = i.offsetParent !== n, s.removeChild(n));
    }
    return e;
  }
  function H(t) {
  ...
  function J(t, e) {
    if (t.parentNode && (p || B(t))) {
      ...
      return e && (n ? (v = v || J(t), h.setAttribute("width", .01), h.setAttribute("height", .01), h.setAttribute("transform", "translate(" + a + "," + o + ")"), v.appendChild(h)) : (m || ((m = J(t)).style.cssText = r), h.style.cssText = r + "width:0.1px;height:0.1px;top:" + o + "px;left:" + a + "px", m.appendChild(h))), h;
    }
  ...
  function M(t, e) {
    var n,
      ...
      c = h ? k : D,
      d = t.parentNode,
      u = d && !h && d.shadowRoot && d.shadowRoot.appendChild ? d.shadowRoot : d;
    if (t === g) return t;
    if (c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), n = h ? v : m, h) l ? (a = -(s = function _getCTM(t) {
      var e,
        n = t.getCTM();
      return n || (e = t.style[x], t.style[x] = "none", t.appendChild(y), n = y.getCTM(), t.removeChild(y), e ? t.style[x] = e : t.style.removeProperty(x.replace(/([A-Z])/g, "-$1").toLowerCase())), n || b.clone();
    }(t)).e / s.a, o = -s.f / s.d, i = b) : t.getBBox ? (s = t.getBBox(), a = (i = (i = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < i.numberOfItems ? function _consolidate(t) {
      for (var e = new T(), n = 0; n < t.numberOfItems; n++) e.multiply(t.getItem(n).matrix);
      return e;
    }(i) : i.getItem(0).matrix : b).a * s.x + i.c * s.y, o = i.b * s.x + i.d * s.y) : (i = new T(), a = o = 0), e && "g" === t.tagName.toLowerCase() && (a = o = 0), (l ? h : d).appendChild(n), n.setAttribute("transform", "matrix(" + i.a + "," + i.b + "," + i.c + "," + i.d + "," + (i.e + a) + "," + (i.f + o) + ")");else {
      if (a = o = 0, S) for (i = t.offsetParent, s = t; (s = s && s.parentNode) && s !== i && s.parentNode;) 4 < (g.getComputedStyle(s)[x] + "").length && (a = s.offsetLeft, o = s.offsetTop, s = 0);
      ...
      (s = n.style).top = t.offsetTop - o + "px", s.left = t.offsetLeft - a + "px", s[x] = r[x], s[E] = r[E], s.position = "fixed" === r.position ? "fixed" : "absolute", u.appendChild(n);
    }
    return n;
  }
  ...
  var p,
    ...
    k = [],
    D = [],
    T = ((e = Matrix2D.prototype).inverse = function inverse() {
      var t = this.a,
        e = this.b,
        n = this.c,
        i = this.d,
  ...
  function getGlobalMatrix(t, e, n, i) {
    if (!t || !t.parentNode || (p || B(t)).documentElement === t) return new T();
    var s = function _forceNonZeroScale(t) {
      ...
      u = new T((h.left - r.left) / 100, (h.top - r.top) / 100, (l.left - r.left) / 100, (l.top - r.top) / 100, r.left + (d ? 0 : function _getDocScrollLeft() {
  ...
  function La(t) {
    R = document, c = window, i = R.body, s = s || t || c.gsap || console.warn("Please gsap.registerPlugin(PathEditor)"), r = s && s.core.context || function () {}, a = oa("div"), (I = oa("textarea")).style.display = "none", i && i.appendChild(I), O = function (t) {
      ...
      var e,
        ...
        a = t.keyCode || t.which,
        o = t.key || a;
      if ("Shift" === o || 16 === a) L = !0;else if ("Control" === o || 17 === a) l = !0;else if ("Meta" === o || 91 === a) d = !0;else if ("Alt" === o || 18 === a) for (u = !0, e = st.length; -1 < --e;) st[e]._onPressAlt();else if (("z" === o || 90 === a) && (l || d) && 1 < tt.length) {
        if (tt.shift(), n = tt[0]) {
    ...
    }, !0), R.addEventListener("keyup", function (t) {
    ...
    }, !0), h = !!c.PointerEvent, Ba(R, "mouseup", xa), Ba(R, "touchend", xa), Ba(R, "touchcancel", aa), Ba(c, "touchmove", aa), i && i.addEventListener("touchstart", aa), G = 1;
  }
  function Ma(t) {
    var e,
      n,
  ...
  function Oa(t, e) {
    ...
    if (n._enabled && n.isPressed && (!t || null == n.touchID || e || !(t.pointerId && t.pointerId !== n.touchID || t.changedTouches && !function _hasTouchID(t, e) {
      ...
      if (r ? (Ca(r, "touchend", n._onRelease), Ca(r, "touchmove", n._onMove), Ca(r, "touchcancel", n._onRelease), Ca(R, "touchstart", Fa)) : Ca(R, "mousemove", n._onMove), h || (Ca(R, "mouseup", n._onRelease), t && t.target && Ca(t.target, "mouseup", n._onRelease)), o ? n.isDragging = !1 : n.vars.onClick && n.vars.onClick.call(n.vars.callbackScope || n, a), t) {
  ...
  var ct,
    dt = ((ct = PathEditor.prototype)._onRelease = function _onRelease(t) {
      ...
      if ("hidden" === this._selection.style.visibility) this.select();else if (u || t && t.altKey) {
        var e,
          i,
          s,
          a,
        ...
        s = new lt(this, this._rawPath, r.j, e, h), this._selection.appendChild(this._handle1), this._selection.appendChild(this._handle2), s._draggable._onPress(t), X = s, this._anchors.push(s), this._selectedAnchors.length = 0, this._selectedAnchors.push(s), this._updateAnchors(), this.update(), this._saveState();
      }
      ...
      u && Math.abs(n[e] - n[i]) < 5 && Math.abs(n[e + 1] - n[1 + i]) < 5 && this._onClickAnchor(t);
    }, ct._onClickHandle2 = function _onClickHandle2() {
      var t = this._editingAnchor,
        e = t.i,
        n = t.segment;
      u && Math.abs(n[e] - n[e + 2]) < 5 && Math.abs(n[e + 1] - n[e + 3]) < 5 && this._onClickAnchor(t);
      ...
      i && (this._handle1.setAttribute("d", i.smooth ? this._circleHandle : this._squareHandle), this._handle2.setAttribute("d", i.smooth ? this._circleHandle : this._squareHandle)), t = i ? i.i : 0, i && (t || i.isClosedStart) ? (e = i.isClosedStart ? s[s.length - 4] : s[t - 2], n = i.isClosedStart ? s[s.length - 3] : s[t - 1], this._handle1.style.visibility = this._line1.style.visibility = u || e !== s[t] || n !== s[t + 1] ? "visible" : "hidden", this._handle1.setAttribute("transform", "translate(" + e + it + n + ")"), this._line1.setAttribute("points", e + it + n + it + s[t] + it + s[t + 1])) : this._handle1.style.visibility = this._line1.style.visibility = "hidden", i && t < s.length - 2 ? (e = s[t + 2], n = s[t + 3], this._handle2.style.visibility = this._line2.style.visibility = u || e !== s[t] || n !== s[t + 1] ? "visible" : "hidden", this._handle2.setAttribute("transform", "translate(" + e + it + n + ")"), this._line2.setAttribute("points", s[t] + it + s[t + 1] + it + e + it + n)) : this._handle2.style.visibility = this._line2.style.visibility = "hidden";
      ...
      n[s] = o = (o * a | 0) / a, n[1 + s] = r = (r * a | 0) / a, e.smooth && (u ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(n[i + 1] - r, n[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), n[i + 2] = ((n[i] + o) * a | 0) / a, n[i + 3] = ((n[i + 1] + r) * a | 0) / a)), this.update();
      ...
      n[i + 2] = o = (o * a | 0) / a, n[i + 3] = r = (r * a | 0) / a, e.smooth && (u ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(n[i + 1] - r, n[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), n[s] = ((n[i] + o) * a | 0) / a, n[1 + s] = ((n[i + 1] + r) * a | 0) / a)), this.update();
  ...
  function PathEditor(t, e) {
    e = e || {}, G || La(), this.vars = e, this.path = "string" == typeof t ? R.querySelectorAll(t)[0] : t, this._g = pa("g", this.path.ownerSVGElement, {
      ...
      fill: "none",
      vectorEffect: "non-scaling-stroke"
    }), this._selection = e._selection || pa("g", this._g, {
  ...
  dt.simplifyPoints = simplifyPoints, dt.pointsToSegment = pointsToSegment, dt.simplifySVG = function (t, e) {
    ...
    if (d = (e = e || {}).tolerance || 1, c = e.precision || 1 / d, void 0 === e.cornerThreshold || e.cornerThreshold, "string" != typeof t && (t = (n = t).getAttribute("d")), "#" !== t.charAt(0) && "." !== t.charAt(0) || (n = R.querySelector(t)) && (t = n.getAttribute("d")), i = !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match(z), !1 !== e.curved) {
  ...
  function jb(t, e, n) {
    return cb(t) && At.test(t) ? gt.querySelector(t) : Array.isArray(t) ? bt(vt([{
      x: ut.getProperty(e, "x"),
      y: ut.getProperty(e, "y")
    }].concat(t), n)) : cb(t) || t && "path" === (t.tagName + "").toLowerCase() ? t : 0;
  }
  function ob(t, e) {
    var n = "Please gsap.registerPlugin(MotionPathPlugin)";
    pt = window, (ut = ut || t || pt.gsap || console.warn(n)) && dt.register(ut), gt = document, _t = gt.body, ft = gt.documentElement, ut && (mt = ut.plugins.motionPath, wt.PathEditor = dt, yt = ut.core.context || function () {}), mt ? (function _initCopyToClipboard() {
  ...
  var ut,
    ...
    wt = (MotionPathHelper.prototype.getString = function getString() {
  ...
  function MotionPathHelper(t, e) {
    ...
    t instanceof ut.core.Tween ? i = (c = t).targets()[0] : (i = ut.utils.toArray(t)[0], c = function _findMotionPathTween(t) {
    ...
    }(i)), s = jb(e.path, i, e), this.offset = b, h = function _getPositionOnPage(t) {
    ...
    }), (l = s && s.ownerSVGElement) ? (e.pathColor && ut.set(s, {
      stroke: e.pathColor
    }), e.pathWidth && ut.set(s, {
      strokeWidth: e.pathWidth
    }), e.pathOpacity && ut.set(s, {
      opacity: e.pathOpacity
    })) : (d = a && i.ownerSVGElement && i.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg", a ? (l = i.ownerSVGElement, u = i.getBBox(), o = (p = function _getConsolidatedMatrix(t) {
      return (t.transform.baseVal.consolidate() || Ct).matrix;
    }(i)).e, r = p.f, b.x = u.x, b.y = u.y) : (l = db("svg", d), _ = !0, _t.appendChild(l), l.setAttribute("viewBox", "0 0 100 100"), l.setAttribute("class", "motion-path-helper"), l.style.cssText = "overflow:visible; background-color: transparent; position:absolute; z-index:5000; width:100px; height:100px; top:" + (h.top - r) + "px; left:" + (h.left - o) + "px;"), u = cb(s) && !At.test(s) ? s : function _getInitialPath(t, e) {
      var n,
        i = [0, 31, 8, 58, 24, 75, 40, 90, 69, 100, 100, 100];
      for (n = 0; n < i.length; n += 2) i[n] += t, i[n + 1] += e;
      return "M" + t + "," + e + "C" + i.join(",");
    }(o, r), (s = db("path", d)).setAttribute("d", u), s.setAttribute("vector-effect", "non-scaling-stroke"), s.style.cssText = "fill:transparent; stroke-width:" + (e.pathWidth || 3) + "; stroke:" + (e.pathColor || "#555") + "; opacity:" + (e.pathOpacity || .6), l.appendChild(s)), (b.x || b.y) && ut.set(s, {
      x: b.x,
      y: b.y
      ...
      xPercent: -50,
      yPercent: -50
    }), c ? (c.vars.motionPath.path ? c.vars.motionPath.path = s : c.vars.motionPath = {
      path: s
    }, f.parent !== ut.globalTimeline && ut.globalTimeline.add(f, function _getGlobalTime(t) {
  ...
  wt.register = ob, wt.create = function (t, e) {
    return new wt(t, e);
  }, wt.editPath = function (t, e) {
    return dt.create(t, e);
  }, wt.version = "3.13.0", t.MotionPathHelper = wt, t.default = wt;

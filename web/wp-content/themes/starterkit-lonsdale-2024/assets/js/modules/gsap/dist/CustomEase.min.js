...
!function (e, t) {
  ...
  function stringToRawPath(e) {
    ...
    for (t = 0; t < v; t++) if (g = r, isNaN(m[t]) ? i = (r = m[t].toUpperCase()) !== m[t] : t--, s = +m[t + 1], a = +m[t + 2], i && (s += y, a += M), t || (h = s, u = a), "M" === r) o && (o.length < 8 ? --p.length : C += o.length), y = h = s, M = u = a, o = [s, a], p.push(o), t += 2, r = "L";else if ("C" === r) i || (y = M = 0), (o = o || [0, 0]).push(s, a, y + 1 * m[t + 3], M + 1 * m[t + 4], y += 1 * m[t + 5], M += 1 * m[t + 6]), t += 6;else if ("S" === r) c = y, f = M, "C" !== g && "S" !== g || (c += y - o[o.length - 4], f += M - o[o.length - 3]), i || (y = M = 0), o.push(c, f, s, a, y += 1 * m[t + 3], M += 1 * m[t + 4]), t += 4;else if ("Q" === r) c = y + 2 / 3 * (s - y), f = M + 2 / 3 * (a - M), i || (y = M = 0), y += 1 * m[t + 3], M += 1 * m[t + 4], o.push(c, f, y + 2 / 3 * (s - y), M + 2 / 3 * (a - M), y, M), t += 4;else if ("T" === r) c = y - o[o.length - 4], f = M - o[o.length - 3], o.push(y + c, M + f, s + 2 / 3 * (y + 1.5 * c - s), a + 2 / 3 * (M + 1.5 * f - a), y = s, M = a), t += 2;else if ("H" === r) db(y, M, y = s, M), t += 1;else if ("V" === r) db(y, M, y, M = s + (i ? M - y : 0)), t += 1;else if ("L" === r || "Z" === r) "Z" === r && (s = h, a = u, o.closed = !0), ("L" === r || .5 < F(y - s) || .5 < F(M - a)) && (db(y, M, s, a), "L" === r && (t += 2)), y = s, M = a;else if ("A" === r) {
      if (x = m[t + 4], d = m[t + 5], c = m[t + 6], f = m[t + 7], n = 7, 1 < x.length && (x.length < 3 ? (f = c, c = d, n--) : (f = d, c = x.substr(2), n -= 2), d = x.charAt(1), x = x.charAt(0)), l = arcToSegment(y, M, +m[t + 1], +m[t + 2], +m[t + 3], +x, +d, (i ? y : 0) + 1 * c, (i ? M : 0) + 1 * f), t += n, l) for (n = 0; n < l.length; n++) o.push(l[n]);
  ...
  var M,
    ...
    n = ((t = CustomEase.prototype).setData = function setData(e, t) {
      ...
      var n,
        ...
        u,
        c,
        f = (e = e || "0,0,1,1").match(y),
        l = 1,
        g = [],
        d = [],
        m = t.precision || 1,
        p = m <= 1;
      if (this.data = e, (v.test(e) || ~e.indexOf("M") && e.indexOf("C") < 0) && (f = stringToRawPath(e)[0]), 4 === (n = f.length)) f.unshift(0, 0), f.push(1, 1), n = 8;else if ((n - 2) % 6) throw "Invalid CustomEase";
      ...
      if (t.invert && (x = -x, p = 0), "string" == typeof e && (e = M.parseEase(e)), e.custom && (e = e.custom), e instanceof CustomEase) n = function rawPathToString(e) {
        ...
        for (var o, h, u, c, f, l = e.length; -1 < --l;) for (h = (o = e[l]).length, u = 0; u < h; u += 2) c = o[u], f = o[u + 1], o[u] = c * t + f * s + r, o[u + 1] = c * n + f * a + i;
        return e._dirty = 1, e;

...
!function (e, t) {
  ...
  function w(e, t) {
    if (e.parentNode && (h || M(e))) {
      ...
      return t && (n ? (x = x || w(e), s.setAttribute("width", .01), s.setAttribute("height", .01), s.setAttribute("transform", "translate(" + i + "," + a + ")"), x.appendChild(s)) : (g || ((g = w(e)).style.cssText = l), s.style.cssText = l + "width:0.1px;height:0.1px;top:" + a + "px;left:" + i + "px", g.appendChild(s))), s;
    }
  ...
  var h,
    ...
    M = function _setDoc(e) {
      ...
      if (f = window, m = new ge(), t) {
        i = (h = t).documentElement, a = t.body, (v = h.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none";
    ...
    k = function _placeSiblings(e, t) {
      var n,
        ...
        d = s ? D : S,
        p = e.parentNode,
        u = p && !s && p.shadowRoot && p.shadowRoot.appendChild ? p.shadowRoot : p;
      if (e === f) return e;
      if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? x : g, s) c ? (i = -(r = function _getCTM(e) {
        var t,
          n = e.getCTM();
        return n || (t = e.style[b], e.style[b] = "none", e.appendChild(v), n = v.getCTM(), e.removeChild(v), t ? e.style[b] = t : e.style.removeProperty(b.replace(/([A-Z])/g, "-$1").toLowerCase())), n || m.clone();
      }(e)).e / r.a, a = -r.f / r.d, o = m) : e.getBBox ? (r = e.getBBox(), i = (o = (o = e.transform ? e.transform.baseVal : {}).numberOfItems ? 1 < o.numberOfItems ? function _consolidate(e) {
        for (var t = new ge(), n = 0; n < e.numberOfItems; n++) t.multiply(e.getItem(n).matrix);
        return t;
      }(o) : o.getItem(0).matrix : m).a * r.x + o.c * r.y, a = o.b * r.x + o.d * r.y) : (o = new ge(), i = a = 0), t && "g" === e.tagName.toLowerCase() && (i = a = 0), (c ? s : p).appendChild(n), n.setAttribute("transform", "matrix(" + o.a + "," + o.b + "," + o.c + "," + o.d + "," + (o.e + i) + "," + (o.f + a) + ")");else {
        if (i = a = 0, y) for (o = e.offsetParent, r = e; (r = r && r.parentNode) && r !== o && r.parentNode;) 4 < (f.getComputedStyle(r)[b] + "").length && (i = r.offsetLeft, a = r.offsetTop, r = 0);
        if ("absolute" !== (l = f.getComputedStyle(e)).position && "fixed" !== l.position) for (o = e.offsetParent; p && p !== o;) i += p.scrollLeft || 0, a += p.scrollTop || 0, p = p.parentNode;
        (r = n.style).top = e.offsetTop - a + "px", r.left = e.offsetLeft - i + "px", r[b] = l[b], r[T] = l[T], r.position = "fixed" === l.position ? "fixed" : "absolute", u.appendChild(n);
      }
      return n;
    },
  ...
  function getGlobalMatrix(e, t, n, o) {
    if (!e || !e.parentNode || (h || M(e)).documentElement === e) return new ge();
    var r = E(e),
      i = P(e) ? D : S,
      a = k(e, n),
      ...
      d = a.parentNode,
      p = !o && N(e),
      u = new ge((s.left - l.left) / 100, (s.top - l.top) / 100, (c.left - l.left) / 100, (c.top - l.top) / 100, l.left + (p ? 0 : C()), l.top + (p ? 0 : L()));
  ...
  function Ka(e, t) {
    var n = "x" === t ? "Width" : "Height",
      o = "scroll" + n,
      r = "client" + n;
    return Math.max(0, Qe(e) ? Math.max(ye[o], l[o]) - (me["inner" + n] || ye[r] || l[r]) : e[o] - e[r]);
  }
  function La(e, t) {
    var n = Ka(e, "x"),
      o = Ka(e, "y");
  ...
  function Pa(e) {
    if (e === me) return p.left = p.top = 0, p.width = p.right = ye.clientWidth || e.innerWidth || l.clientWidth || 0, p.height = p.bottom = (e.innerHeight || 0) - 20 < ye.clientHeight ? ye.clientHeight : e.innerHeight || l.clientHeight || 0, p;
  ...
  function Ra(e, t) {
    var n,
      ...
      r,
      i = Te(e)[0];
    return i.nodeType || i === me ? u(i, t) : _(e.left) ? {
  ...
  function $a(i, r) {
    ...
    var a,
      ...
      w = 0,
      b = 0;
    B && !1 !== r.force3D ? (c = "translate3d(", d = "px,0px)") : O && (c = "translate(", d = "px)"), this.scrollTop = function (e, t) {
  ...
  function _a(e) {
    if (X() && document.body) {
      ...
      me = window, ve = document, ye = ve.documentElement, l = ve.body, s = fa("div"), Ae = !!window.PointerEvent, (we = fa("div")).style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab", Xe = "grab" === we.style.cursor ? "grab" : "move", Se = t && -1 !== t.userAgent.toLowerCase().indexOf("android"), Me = "ontouchstart" in ye && "orientation" in me || t && (0 < t.MaxTouchPoints || 0 < t.msMaxTouchPoints), o = fa("div"), r = fa("div"), i = r.style, a = l, i.display = "inline-block", i.position = "relative", o.style.cssText = "width:90px;height:40px;padding:10px;overflow:auto;visibility:hidden", o.appendChild(r), a.appendChild(o), n = r.offsetHeight + 18 > o.scrollHeight, a.removeChild(o), R = n, Ee = function (e) {
        ...
        return o;
      }("touchstart,touchmove,touchend,touchcancel"), za(ve, "touchcancel", aa), za(me, "touchmove", aa), l && l.addEventListener("touchstart", aa), za(ve, "contextmenu", function () {
        for (var e in Ie) Ie[e].isPressed && Ie[e].endDrag();
      }), xe = be = Y();
    }
    var n, o, r, i, a;
    xe ? (_e = xe.plugins.inertia, Le = xe.core.context || function () {}, c = xe.utils.checkPrefix, O = c(O), Ye = c(Ye), Te = xe.utils.toArray, Ce = xe.core.getStyleSaver, B = !!c("perspective")) : e && console.warn("Please gsap.registerPlugin(Draggable)");
  }
  var xe,
    me,
    ve,
    ...
    Qe = function _isRoot(e) {
      return !(e && e !== ye && 9 !== e.nodeType && e !== ve.body && e !== me && e.nodeType && e.parentNode);
    },
    p = {},
    Ge = {},
    ...
    I = ((n = EventDispatcher.prototype).addEventListener = function addEventListener(e, t) {
  ...
  var Ve,
    ...
    }(Draggable, Ve = I), Draggable.register = function register(e) {
      xe = e, _a();
  ...
  function Draggable(h, p) {
    var e;
    e = Ve.call(this) || this, be || _a(1), h = Te(h)[0], e.styles = Ce && Ce(h, "transform,left,top"), _e = _e || xe.plugins.inertia, e.vars = p = ra(p || {}), e.target = h, e.x = e.y = e.rotation = 0, e.dragResistance = parseFloat(p.dragResistance) || 0, e.edgeResistance = isNaN(p.edgeResistance) ? 1 : parseFloat(p.edgeResistance) || 0, e.lockAxis = p.lockAxis, e.autoScroll = p.autoScroll || 0, e.lockedAxis = null, e.allowEventDefault = !!p.allowEventDefault, xe.getProperty(h, "x");
    function Sg(e, t) {
    ...
    function Ah(e) {
      if (J.autoScroll && J.isDragging && (te || C)) {
        var t,
          ...
          c = h,
          d = 15 * J.autoScroll;
        for (te = !1, We.scrollTop = null != me.pageYOffset ? me.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop, We.scrollLeft = null != me.pageXOffset ? me.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft, r = J.pointerX - We.scrollLeft, i = J.pointerY - We.scrollTop; c && !n;) t = (n = Qe(c.parentNode)) ? We : c.parentNode, o = n ? {
    ...
    function Bh(e, t) {
      var n,
        ...
        r = J.x,
        i = J.y;
      h._gsap || (se = xe.core.getCache(h)), se.uncache && xe.getProperty(h, "x"), W ? (J.x = parseFloat(se.x), J.y = parseFloat(se.y)) : Q ? J.x = J.rotation = parseFloat(se.rotation) : f ? (J.y = f.top(), J.x = f.left()) : (J.y = parseFloat(h.style.top || (o = Na(h)) && o.top) || 0, J.x = parseFloat(h.style.left || (o || {}).left) || 0), (P || Y || N) && !t && (J.isDragging || J.isThrowing) && (N && (He.x = J.x, He.y = J.y, (n = N(He)).x !== J.x && (J.x = n.x, C = !0), n.y !== J.y && (J.y = n.y, C = !0)), P && (n = P(J.x)) !== J.x && (J.x = n, Q && (J.rotation = n), C = !0), Y && ((n = Y(J.y)) !== J.y && (J.y = n), C = !0)), C && Ah(!0), e || (J.deltaX = J.x - r, J.deltaY = J.y - i, Qa(J, "throwupdate", "onThrowUpdate"));
    }
    function Ch(a, l, s, n) {
      return null == l && (l = -Be), null == s && (s = Be), Z(a) ? function (e) {
        var t = J.isPressed ? 1 - J.edgeResistance : 1;
        return a.call(J, (s < e ? s + (e - s) * t : e < l ? l + (e - l) * t : e) * n) * n;
      } : Ne(a) ? function (e) {
        for (var t, n, o = a.length, r = 0, i = Be; -1 < --o;) (n = (t = a[o]) - e) < 0 && (n = -n), n < i && l <= t && t <= s && (r = o, i = n);
        return a[r];
      } : isNaN(a) ? function (e) {
        return e;
      } : function () {
      ...
      E = !1, f ? (f.calibrate(), J.minX = S = -f.maxScrollLeft(), J.minY = A = -f.maxScrollTop(), J.maxX = D = J.maxY = X = 0, E = !0) : p.bounds && (e = Ra(p.bounds, h.parentNode), Q ? (J.minX = S = e.left, J.maxX = D = e.left + e.width, J.minY = A = J.maxY = X = 0) : _(p.bounds.maxX) && _(p.bounds.maxY) ? (t = Ra(h, h.parentNode), J.minX = S = Math.round(Sg(G, "px") + e.left - t.left), J.minY = A = Math.round(Sg(V, "px") + e.top - t.top), J.maxX = D = Math.round(S + (e.width - t.width)), J.maxY = X = Math.round(A + (e.height - t.height))) : (e = p.bounds, J.minX = S = e.minX, J.minY = A = e.minY, J.maxX = D = e.maxX, J.maxY = X = e.maxY), D < S && (J.minX = D, J.maxX = D = S, S = J.minX), X < A && (J.minY = X, J.maxY = X = A, A = J.minY), Q && (J.minRotation = S, J.maxRotation = D), E = !0), p.liveSnap && (n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap, o = Ne(n) || Z(n), Q ? (P = Ch(o ? n : n.rotation, S, D, 1), Y = null) : n.points ? N = function buildPointSnapFunc(s, l, c, d, p, u, h) {
        return u = u && u < Be ? u * u : Be, Z(s) ? function (e) {
          var t,
            ...
            i = e.x,
            a = e.y;
          return e.x = i = c < i ? c + (i - c) * r : i < l ? l + (i - l) * r : i, e.y = a = p < a ? p + (a - p) * r : a < d ? d + (a - d) * r : a, (t = s.call(J, e)) !== e && (e.x = t.x, e.y = t.y), 1 !== h && (e.x *= h, e.y *= h), u < Be && (n = e.x - i, o = e.y - a, u < n * n + o * o && (e.x = i, e.y = a)), e;
        } : Ne(s) ? function (e) {
          for (var t, n, o, r, i = s.length, a = 0, l = Be; -1 < --i;) (r = (t = (o = s[i]).x - e.x) * t + (n = o.y - e.y) * n) < l && (a = i, l = r);
          return l <= u ? s[a] : e;
        } : function (e) {
          return e;
        };
      }(o ? n : n.points, S, D, A, X, n.radius, f ? -1 : 1) : (K && (P = Ch(o ? n : n.x || n.left || n.scrollLeft, S, D, f ? -1 : 1)), U && (Y = Ch(o ? n : n.y || n.top || n.scrollTop, A, X, f ? -1 : 1))));
    }
    function Fh() {
    ...
    function Hh(e, t) {
      var n, o, r, i;
      e && _e ? (!0 === e && (n = p.snap || p.liveSnap || {}, o = Ne(n) || Z(n), e = {
        resistance: (p.throwResistance || p.resistance || 1e3) / (Q ? 10 : 1)
      }, Q ? e.rotation = Ua(J, o ? n : n.rotation, D, S, 1, t) : (K && (e[G] = Ua(J, o ? n : n.points || n.x || n.left, D, S, f ? -1 : 1, t || "x" === J.lockedAxis)), U && (e[V] = Ua(J, o ? n : n.points || n.y || n.top, X, A, f ? -1 : 1, t || "y" === J.lockedAxis)), (n.points || Ne(n) && $(n[0])) && (e.linkedProps = G + "," + V, e.radius = n.radius))), J.isThrowing = !0, i = isNaN(p.overshootTolerance) ? 1 === p.edgeResistance ? 0 : 1 - J.edgeResistance + .2 : p.overshootTolerance, e.duration || (e.duration = {
        ...
        onUpdateParams: p.fastMode ? [J, "onthrowupdate", "onThrowUpdate"] : n && n.radius ? [!1, !0] : []
      }), p.fastMode || (f && (f._skip = !0), r.render(1e9, !0, !0), Bh(!0, !0), J.endX = J.x, J.endY = J.y, Q && (J.endRotation = J.x), r.play(0), Bh(!0, !0), f && (f._skip = !1))) : E && J.applyBounds();
    }
    function Ih(e) {
      var t,
        n = k;
      k = getGlobalMatrix(h.parentNode, !0), e && J.isPressed && !k.equals(n || new ge()) && (t = n.inverse().apply({
        x: w,
        y: b
    ...
    function Mh(e, t) {
      var n;
      if (!u || J.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Re() - le < 30 && Ee[J.pointerEvent.type]) z && e && u && Ba(e);else {
        if (B = pe(), H = !1, J.pointerEvent = e, Ee[e.type] ? (y = ~e.type.indexOf("touch") ? e.currentTarget || e.target : de, za(y, "touchend", fe), za(y, "touchmove", ue), za(y, "touchcancel", fe), za(de, "touchstart", Ea)) : (y = null, za(de, "mousemove", ue)), O = null, Ae && y || (za(de, "mouseup", fe), e && e.target && za(e.target, "mouseup", fe)), v = ae.call(J, e.target) && !1 === p.dragClickables && !t) return za(e.target, "change", fe), Qa(J, "pressInit", "onPressInit"), Qa(J, "press", "onPress"), Wa(q, !0), void (z = !1);
        if (R = !(!y || K == U || !1 === J.vars.allowNativeTouchScrolling || J.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (K ? "y" : "x"), (z = !R && !J.allowEventDefault) && (Ba(e), za(me, "touchforcechange", Ba)), e.changedTouches ? (e = x = e.changedTouches[0], m = e.identifier) : e.pointerId ? m = e.pointerId : x = m = null, Pe++, function _addToRenderQueue(e) {
          Oe.push(e), 1 === Oe.length && xe.ticker.add(ua);
        }(Ah), b = J.pointerY = e.pageY, w = J.pointerX = e.pageX, Qa(J, "pressInit", "onPressInit"), (R || J.autoScroll) && La(h.parentNode), !h.parentNode || !J.autoScroll || f || Q || !h.parentNode._gsMaxScrollX || we.parentNode || h.getBBox || (we.style.width = h.parentNode.scrollWidth + "px", h.parentNode.appendChild(we)), Jh(), J.tween && J.tween.kill(), J.isThrowing = !1, xe.killTweensOf(f || h, o, !0), f && xe.killTweensOf(h, {
          scrollTo: 1
        }, !0), J.tween = J.lockedAxis = null, !p.zIndexBoost && (Q || f || !1 === p.zIndexBoost) || (h.style.zIndex = Draggable.zIndex++), J.isPressed = !0, g = !(!p.onDrag && !J._listeners.drag), s = !(!p.onMove && !J._listeners.move), !1 !== p.cursor || p.activeCursor) for (n = q.length; -1 < --n;) xe.set(q[n], {
    ...
    function Qh(e) {
      if (e && J.isDragging && !f) {
        ...
        (n || o) && (k ? (w -= n * k.a + o * k.c, b -= o * k.d + n * k.b) : (w -= n, b -= o), t._gsScrollX += n, t._gsScrollY += o, he(J.pointerX, J.pointerY));
      }
    }
    function Rh(e) {
      var t = Re(),
      ...
      if ((r || o && !1 !== J.vars.suppressClickOnDrag) && e.stopImmediatePropagation && e.stopImmediatePropagation(), n && (!J.pointerEvent || !J.pointerEvent.defaultPrevented) && (!r || l && !a)) return l && r && (c = le), void (F = le);
      (J.isPressed || o || n) && (l && e.detail && n && !i || Ba(e)), n || o || H || (e && e.target && (J.pointerEvent = e), Qa(J, "click", "onClick"));
    }
    function Sh(e) {
      return k ? {
      ...
      fe = function onRelease(e, t) {
        if (u && J.isPressed && (!e || null == m || t || !(e.pointerId && e.pointerId !== m && e.target !== h || e.changedTouches && !function _hasTouchID(e, t) {
          ...
          var n,
            ...
            d = xe.delayedCall(.001, Lh);
          if (y ? (Aa(y, "touchend", onRelease), Aa(y, "touchmove", ue), Aa(y, "touchcancel", onRelease), Aa(de, "touchstart", Ea)) : Aa(de, "mousemove", ue), Aa(me, "touchforcechange", Ba), Ae && y || (Aa(de, "mouseup", onRelease), e && e.target && Aa(e.target, "mouseup", onRelease)), C = !1, s && (ee = ze = Re(), J.isDragging = !1), xa(Ah), v && !c) return e && (Aa(e.target, "change", onRelease), J.pointerEvent = l), Wa(q, !1), Qa(J, "release", "onRelease"), Qa(J, "click", "onClick"), void (v = !1);
          for (o = q.length; -1 < --o;) Ma(q[o], "cursor", p.cursor || (!1 !== p.cursor ? Xe : null));
          if (Pe--, e) {
          ...
          return c && l ? (Ba(l), z = !0, Qa(J, "release", "onRelease")) : l && !s ? (z = !1, B && (p.snap || p.bounds) && Hh(p.inertia || p.throwProps), Qa(J, "release", "onRelease"), Se && "touchmove" === l.type || -1 !== l.type.indexOf("cancel") || (Qa(J, "click", "onClick"), Re() - le < 300 && Qa(J, "doubleclick", "onDoubleClick"), i = l.target || h, le = Re(), a = function syntheticClick() {
            le === F || !J.enabled() || J.isPressed || l.defaultPrevented || (i.click ? i.click() : de.createEvent && ((r = de.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, me, 1, J.pointerEvent.screenX, J.pointerEvent.screenY, J.pointerX, J.pointerY, !1, !1, !1, !1, 0, null), i.dispatchEvent(r)));
          }, Se || l.defaultPrevented || xe.delayedCall(.05, a))) : (Hh(p.inertia || p.throwProps), J.allowEventDefault || !l || !1 === p.dragClickables && ae.call(J, l.target) || !s || R && (!O || R !== O) || !1 === l.cancelable ? z = !1 : (z = !0, Ba(l)), Qa(J, "release", "onRelease")), pe() && d.duration(J.tween.duration()), s && Qa(J, "dragend", "onDragEnd"), !0;
        }
        z && e && u && Ba(e);
      };
    return (t = Draggable.get(h)) && t.kill(), e.startDrag = function (e, t) {
      var n, o, r, i;
      Mh(e || J.pointerEvent, !0), t && !J.hitTest(e || J.pointerEvent) && (n = Pa(e || J.pointerEvent), o = Pa(h), r = Sh({
        x: n.left + n.width / 2,
        y: n.top + n.height / 2
      }), i = Sh({
        x: o.left + o.width / 2,
        y: o.top + o.height / 2
      }), w -= r.x - i.x, b -= r.y - i.y), J.isDragging || (J.isDragging = H = !0, Qa(J, "dragstart", "onDragStart"));
      ...
      return "element" === s && (a = Pa(J.target), l = Pa(e)), n = "start" === s ? J.x - T : "velocity" === s ? _e.getVelocity(h, G) : a.left + a.width / 2 - (l.left + l.width / 2), Q ? n < 0 ? "counter-clockwise" : "clockwise" : (t = t || 2, o = "start" === s ? J.y - M : "velocity" === s ? _e.getVelocity(h, V) : a.top + a.height / 2 - (l.top + l.height / 2), i = (r = Math.abs(n / o)) < 1 / t ? "" : n < 0 ? "left" : "right", r < t && ("" !== i && (i += "-"), i += o < 0 ? "up" : "down"), i);
    }, e.applyBounds = function (e, t) {
      var n, o, r, i, a, l;
      if (e && p.bounds !== e) return p.bounds = e, J.update(!0, t);
      if (Bh(!0), Eh(), E && !pe()) {
        if (n = J.x, o = J.y, D < n ? n = D : n < S && (n = S), X < o ? o = X : o < A && (o = A), (J.x !== n || J.y !== o) && (r = !0, J.x = J.endX = n, Q ? J.endRotation = n : J.y = J.endY = o, Ah(C = !0), J.autoScroll && !J.isDragging)) for (La(h.parentNode), i = h, We.scrollTop = null != me.pageYOffset ? me.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop, We.scrollLeft = null != me.pageXOffset ? me.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft; i && !l;) a = (l = Qe(i.parentNode)) ? We : i.parentNode, U && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY), K && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX), i = a;
        J.isThrowing && (r || J.endX > D || J.endX < S || J.endY > X || J.endY < A) && Hh(p.inertia || p.throwProps, r);
      }
      return J;
      ...
      if (t && J.isPressed) {
        ...
        i.apply({
          x: o.e - r.x,
          y: o.f - r.y
        }, r), J.x -= r.x - i.e, J.y -= r.y - i.f, Ah(!0), Jh();
      }
      var a = J.x,
        l = J.y;
      return Ih(!t), e ? J.applyBounds() : (C && n && Ah(!0), Bh(!0)), t && (he(J.pointerX, J.pointerY), C && Ah(!0)), J.isPressed && !t && (K && .01 < Math.abs(a - J.x) || U && .01 < Math.abs(l - J.y) && !Q) && Jh(), J.autoScroll && (La(h.parentNode, J.isDragging), te = J.isDragging, Ah(!0), Ia(h, Qh), Ha(h, Qh)), J;
    }, e.enable = function (e) {
      var t,
        n,
        o,
      ...
      if (!1 !== p.cursor && (r.cursor = p.cursor || Xe), xe.utils.checkPrefix("touchCallout") && (r.touchCallout = "none"), "soft" !== e) {
        for (ta(q, K == U ? "none" : p.allowNativeTouchScrolling && h.scrollHeight === h.clientHeight == (h.scrollWidth === h.clientHeight) || p.allowEventDefault ? "manipulation" : K ? "pan-y" : "pan-x"), n = q.length; -1 < --n;) o = q[n], Ae || za(o, "mousedown", Mh), za(o, "touchstart", Mh), za(o, "click", Rh, !0), xe.set(o, r), o.getBBox && o.ownerSVGElement && K != U && xe.set(o.ownerSVGElement, {
          touchAction: p.allowNativeTouchScrolling || p.allowEventDefault ? "manipulation" : K ? "pan-y" : "pan-x"
        }), p.allowContextMenu || za(o, "contextmenu", zh);
        Wa(q, !1);
      }
      return Ha(h, Qh), u = !0, _e && "soft" !== e && _e.track(f || h, W ? "x,y" : Q ? "rotation" : "top,left"), h._gsDragID = t = h._gsDragID || "d" + Fe++, Ie[t] = J, f && (f.enable(), f.element._gsDragID = t), (p.bounds || Q) && Jh(), p.bounds && J.applyBounds(), J;
    }, e.disable = function (e) {
      for (var t, n = J.isDragging, o = q.length; -1 < --o;) Ma(q[o], "cursor", null);
      if ("soft" !== e) {
        for (ta(q, null), o = q.length; -1 < --o;) t = q[o], Ma(t, "touchCallout", null), Aa(t, "mousedown", Mh), Aa(t, "touchstart", Mh), Aa(t, "click", Rh, !0), Aa(t, "contextmenu", zh);
        Wa(q, !0), y && (Aa(y, "touchcancel", fe), Aa(y, "touchend", fe), Aa(y, "touchmove", ue)), Aa(de, "mouseup", fe), Aa(de, "mousemove", ue);
      }
      return Ia(h, Qh), u = !1, _e && "soft" !== e && (_e.untrack(f || h, W ? "x,y" : Q ? "rotation" : "top,left"), J.tween && J.tween.kill()), f && f.disable(), xa(Ah), J.isDragging = J.isPressed = v = !1, n && Qa(J, "dragend", "onDragEnd"), J;
    }, e.enabled = function (e, t) {
      return arguments.length ? e ? J.enable(t) : J.disable(t) : u;
    }, e.kill = function () {
      return J.isThrowing = !1, J.tween && J.tween.kill(), J.disable(), xe.set(q, {
        clearProps: "userSelect"
      }), delete Ie[h._gsDragID], J;
    }, e.revert = function () {
    ...
    }, p)), h.style.overflowY = U && !Me ? "auto" : "hidden", h.style.overflowX = K && !Me ? "auto" : "hidden", h = f.content), Q ? o.rotation = 1 : (K && (o[G] = 1), U && (o[V] = 1)), se.force3D = !("force3D" in p) || p.force3D, Le(_assertThisInitialized(e)), e.enable(), e;
  }
  !function _setDefaults(e, t) {
    ...
    isDragging: !1,
    isPressed: !1
  }), F.zIndex = 1e3, F.version = "3.13.0", Y() && xe.registerPlugin(F), e.Draggable = F, e.default = F;

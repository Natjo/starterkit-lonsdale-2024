...
!function (t, e) {
  ...
  function r(t) {
    var e,
      r = o;
    if (.05 <= t - s) for (s = t; r;) ((e = r.g(r.t, r.p)) !== r.v1 || .2 < t - r.t1) && (r.v2 = r.v1, r.v1 = e, r.t2 = r.t1, r.t1 = t), r = r._next;
  }
  function t() {
  ...
  var i,
    ...
    d = function () {
      ...
      return e.get = function get(t, e) {
        ...
        return r = parseFloat(e ? n.v1 : n.g(n.t, n.p)) - parseFloat(n.v2), (i = n.rCap) && (r %= i) !== r % (i / 2) && (r = r < 0 ? r + i : r - i), function _round(t) {
  ...
  var h,
    ...
    D = {
      ...
      render: function render(t, e) {
        var r = e._pt;
        if ((t = k(e.tween._time / e.tween._dur)) || !w()) for (; r;) r.set(r.t, r.p, W(r.s + r.c1 * t + r.c2 * t * t) + r.u, r.d, t), r = r._next;else e.styles.revert();
      }
    };

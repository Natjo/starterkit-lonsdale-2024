...
!function (t, e) {
  ...
  function measureSegment(t, e, n) {
    ...
    for (T.length = C.length = 0, a = e + 2; a < b; a += 6) {
      if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - R, g = t[a + 3] - R, f = t[a + 1] - R, l = h = p = c = 0, H(o) < .01 && H(u) < .01 && H(s) + H(f) < .01) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);else for (r = 1; r <= x; r++) l = h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m), p = c - (c = (m * m * u + 3 * d * (m * g + d * f)) * m), (y = $(p * p + l * l)) < S && (S = y), N += y, T[L++] = N;
      M += o, R += u;
    }
    if (_) for (_ -= N; L < T.length; L++) T[L] += _;
    if (T.length && S) {
      if (t.totalLength = w = T[T.length - 1] || 0, w / (t.minLength = S) < 9999) for (y = v = 0, r = 0; r < w; r += S) C[y++] = T[v] < r ? ++v : v;
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < x; e++) if (p = o, isNaN(m[e]) ? i = (o = m[e].toUpperCase()) !== m[e] : e--, r = +m[e + 1], a = +m[e + 2], i && (r += y, a += w), e || (l = r, h = a), "M" === o) s && (s.length < 8 ? --v.length : P += s.length), y = l = r, w = h = a, s = [r, a], v.push(s), e += 2, o = "L";else if ("C" === o) i || (y = w = 0), (s = s || [0, 0]).push(r, a, y + 1 * m[e + 3], w + 1 * m[e + 4], y += 1 * m[e + 5], w += 1 * m[e + 6]), e += 6;else if ("S" === o) u = y, g = w, "C" !== p && "S" !== p || (u += y - s[s.length - 4], g += w - s[s.length - 3]), i || (y = w = 0), s.push(u, g, r, a, y += 1 * m[e + 3], w += 1 * m[e + 4]), e += 4;else if ("Q" === o) u = y + 2 / 3 * (r - y), g = w + 2 / 3 * (a - w), i || (y = w = 0), y += 1 * m[e + 3], w += 1 * m[e + 4], s.push(u, g, y + 2 / 3 * (r - y), w + 2 / 3 * (a - w), y, w), e += 4;else if ("T" === o) u = y - s[s.length - 4], g = w - s[s.length - 3], s.push(y + u, w + g, r + 2 / 3 * (y + 1.5 * u - r), a + 2 / 3 * (w + 1.5 * g - a), y = r, w = a), e += 2;else if ("H" === o) Cf(y, w, y = r, w), e += 1;else if ("V" === o) Cf(y, w, y, w = r + (i ? w - y : 0)), e += 1;else if ("L" === o || "Z" === o) "Z" === o && (r = l, a = h, s.closed = !0), ("L" === o || .5 < H(y - r) || .5 < H(w - a)) && (Cf(y, w, r, a), "L" === o && (e += 2)), y = r, w = a;else if ("A" === o) {
      if (c = m[e + 4], d = m[e + 5], u = m[e + 6], g = m[e + 7], n = 7, 1 < c.length && (c.length < 3 ? (g = u, u = d, n--) : (g = d, u = c.substr(2), n -= 2), d = c.charAt(1), c = c.charAt(0)), f = arcToSegment(y, w, +m[e + 1], +m[e + 2], +m[e + 3], +c, +d, (i ? y : 0) + 1 * u, (i ? w : 0) + 1 * g), e += n, f) for (n = 0; n < f.length; n++) s.push(f[n]);
  ...
  function aa(t, e) {
    ...
    if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), n = l ? E : b, l) h ? (o = -(a = function _getCTM(t) {
      ...
      return e;
    }(r) : r.getItem(0).matrix : I).a * a.x + r.c * a.y, i = r.b * a.x + r.d * a.y) : (r = new j(), o = i = 0), e && "g" === t.tagName.toLowerCase() && (o = i = 0), (h ? l : g).appendChild(n), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")");else {
      if (o = i = 0, k) for (r = t.offsetParent, a = t; (a = a && a.parentNode) && a !== r && a.parentNode;) 4 < (v.getComputedStyle(a)[z] + "").length && (o = a.offsetLeft, i = a.offsetTop, a = 0);

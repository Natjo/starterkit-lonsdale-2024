...
!function (t, e) {
  ...
  function p(t) {
    ...
    if (y = window, m = new F(), e) {
      ...
      r && r.appendChild && (r.appendChild(i), i.appendChild(n), i.setAttribute("style", "position:static;transform:translate3d(0,0,1px)"), w = n.offsetParent !== i, r.removeChild(i));
    }
    return e;
  }
  function t() {
  ...
  function x(t, e) {
    if (t.parentNode && (g || p(t))) {
      ...
      return e && (i ? (d = d || x(t), l.setAttribute("width", .01), l.setAttribute("height", .01), l.setAttribute("transform", "translate(" + a + "," + s + ")"), d.appendChild(l)) : (f || ((f = x(t)).style.cssText = o), l.style.cssText = o + "width:0.1px;height:0.1px;top:" + s + "px;left:" + a + "px", f.appendChild(l))), l;
    }
  ...
  function z(t) {
    var e,
      i = t.getCTM();
    return i || (e = t.style[k], t.style[k] = "none", t.appendChild(s), i = s.getCTM(), t.removeChild(s), e ? t.style[k] = e : t.style.removeProperty(k.replace(/([A-Z])/g, "-$1").toLowerCase())), i || m.clone();
  }
  function A(t, e) {
    var i,
      n,
    ...
    if (t === y) return t;
    if (h.length || h.push(x(t, 1), x(t, 2), x(t, 3)), i = l ? d : f, l) u ? (a = -(r = z(t)).e / r.a, s = -r.f / r.d, n = m) : t.getBBox ? (r = t.getBBox(), a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
      for (var e = new F(), i = 0; i < t.numberOfItems; i++) e.multiply(t.getItem(i).matrix);
      return e;
    }(n) : n.getItem(0).matrix : m).a * r.x + n.c * r.y, s = n.b * r.x + n.d * r.y) : (n = new F(), a = s = 0), e && "g" === t.tagName.toLowerCase() && (a = s = 0), (u ? l : p).appendChild(i), i.setAttribute("transform", "matrix(" + n.a + "," + n.b + "," + n.c + "," + n.d + "," + (n.e + a) + "," + (n.f + s) + ")");else {
      if (a = s = 0, w) for (n = t.offsetParent, r = t; (r = r && r.parentNode) && r !== n && r.parentNode;) 4 < (y.getComputedStyle(r)[k] + "").length && (a = r.offsetLeft, s = r.offsetTop, r = 0);
      ...
      (r = i.style).top = t.offsetTop - s + "px", r.left = t.offsetLeft - a + "px", r[k] = o[k], r[C] = o[C], r.position = "fixed" === o.position ? "fixed" : "absolute", c.appendChild(i);
    }
    return i;
  }
  ...
  var g,
    ...
    E = [],
    M = [],
    F = ((i = Matrix2D.prototype).inverse = function inverse() {
      var t = this.a,
        e = this.b,
        i = this.c,
        n = this.d,
  ...
  function ja(e, i, n) {
    ...
    for (a = "none" === c("display"), e.isVisible && !a || (a && (fa(e, ["display"]).display = i.display), e.matrix = i.matrix, e.width = l = e.width || i.width, e.height = h = e.height || i.height), fa(e, R), s = window.getComputedStyle(o); d--;) f[R[d]] = s[R[d]];
    if (f.gridArea = "1 / 1 / 1 / 1", f.transition = "none", f.position = "absolute", f.width = l + "px", f.height = h + "px", f.top || (f.top = "0px"), f.left || (f.left = "0px"), p) r = new ht(o);else if ((r = _(e, D)).position = "absolute", e.simple) {
  ...
  function Aa(t, e, r, i) {
    ...
    var a,
      ...
      U = R[1 !== i ? "to" : "from"];
    for (s in e.idLookup) d = e.alt[s] ? va(e, t, s) : e.idLookup[s], u = d.element, n = t.idLookup[s], !t.alt[s] || u !== n.element || !t.alt[s].isVisible && d.isVisible || (n = t.alt[s]), n ? (h = {
      t: u,
      b: n,
      a: d,
      sd: n.element === u ? 0 : d.isVisible ? 1 : -1
    }, H.push(h), h.sd && (h.sd < 0 && (h.b = d, h.a = n), J && fa(h.b, z ? et[z] : nt), T && H.push(h.swap = {
      t: n.element,
      b: h.b,
      a: h.a,
      sd: -h.sd,
    ...
    z && (st[z] || ba(z)).forEach(function (e) {
      return Y[e] = function (t) {
        return H[t].a.props[e];
      };
    }), H.finalStates = f = [], m = function run() {
      for (ea(H), za(!0), l = 0; l < H.length; l++) h = H[l], g = h.a, v = h.b, !D || g.isDifferent(v) || h.entering ? (u = h.t, !L || h.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)), v.isVisible && g.isVisible ? (h.sd < 0 ? (p = new ht(u, z, t.simple), ot(p, g, A, 0, 0, p), p.matrix = getGlobalMatrix(u, !1, !1, !0), p.css = h.b.css, h.a = g = p, T && (u.style.opacity = J ? v.opacity : g.opacity), O && q.push(u)) : 0 < h.sd && T && (u.style.opacity = J ? g.opacity - v.opacity : "0"), ot(g, v, A, z)) : v.isVisible !== g.isVisible && (v.isVisible ? g.isVisible || (v.css = g.css, j.push(v), H.splice(l--, 1), S && L && ot(g, v, A, z)) : (g.isVisible && G.push(g), H.splice(l--, 1))), A || (u.style.maxWidth = Math.max(g.width, v.width) + "px", u.style.maxHeight = Math.max(g.height, v.height) + "px", u.style.minWidth = Math.min(g.width, v.width) + "px", u.style.minHeight = Math.min(g.height, v.height) + "px"), L && I && u.classList.add(I)) : H.splice(l--, 1), f.push(g);
      var e;
      if (I && (e = f.map(function (t) {
        return t.element;
      }), L && e.forEach(function (t) {
        return t.classList.remove(I);
      })), za(!1), A ? (Y.scaleX = function (t) {
        return H[t].a.scaleX;
      }, Y.scaleY = function (t) {
        return H[t].a.scaleY;
      }) : (Y.width = function (t) {
      ...
      }, Y.autoRound = r.autoRound || !1), Y.x = function (t) {
        return H[t].a.x + "px";
      }, Y.y = function (t) {
        return H[t].a.y + "px";
      ...
      }, Y.zIndex = P, Y.immediateRender = !1 !== r.immediateRender), T && (Y.opacity = function (t) {
      ...
      }), C && c.length) for (s in W = _(Y, rt), "scale" in C && (C.scaleX = C.scaleY = C.scale, delete C.scale), C) (a = _(C[s], at))[s] = Y[s], !("duration" in a) && "duration" in Y && (a.duration = Y.duration), a.stagger = Y.stagger, U.call(R, c, a, 0), delete W[s];
      (c.length || j.length || G.length) && (I && R.add(function () {
        return X(e, I, R._zTime < 0 ? "remove" : "add");
      }, 0) && !E && X(e, I, "add"), c.length && U.call(R, c, W, 0)), sa(b, G, R), sa(w, j, R);
  ...
  var I,
    ...
    G = function _parseElementState(t, e, i, n) {
      return t instanceof ht ? t : t instanceof ut ? function _findElStateInState(t, e) {
        return e && t.idLookup[G(e).id] || t.elementStates[0];
      }(t, n) : new ht("string" == typeof t ? V(t) || console.warn(t + " not found") : t, e, i);
    },
    ot = function _fit(t, e, i, n, r, a) {
      ...
      return F || !m ? (b = w = 1, S = s = 0) : (p = (h = function _getInverseGlobalMatrix(t) {
      ...
      }(m)).clone().multiply(e.ctm ? e.matrix.clone().multiply(e.ctm) : e.matrix), S = W(Math.atan2(p.b, p.a) * O), s = W(Math.atan2(p.c, p.d) * O + S) % 360, b = Math.sqrt(Math.pow(p.a, 2) + Math.pow(p.b, 2)), w = Math.sqrt(Math.pow(p.c, 2) + Math.pow(p.d, 2)) * Math.cos(s * N), r && (r = I(r)[0], u = Q.getProperty(r), c = r.getBBox && "function" == typeof r.getBBox && r.getBBox(), C = {
        scaleX: u("scaleX"),
        scaleY: u("scaleY"),
        ...
        x: E,
        y: M
      })).x - o.x, v += l.y - o.y) : (h.e = h.f = 0, g += (l = h.apply({
        x: E - t.matrix.e,
        y: M - t.matrix.f
      })).x, v += l.y), g = P(g, .02), v = P(v, .02), !a || a instanceof ht ? (d.x = g + "px", d.y = v + "px", d.renderTransform(1, d)) : _ && _.revert(), a && (a.x = g, a.y = v, a.rotation = S, a.skewX = s, i ? (a.scaleX = b, a.scaleY = w) : (a.width = y, a.height = x)), a || d;
    },
    j = [],
  ...
  function FlipState(t, e, i) {
    if (this.props = e && e.props, this.simple = !(!e || !e.simple), i) this.targets = ra(t), this.elementStates = t, Da(this);else {
      this.targets = I(t);
  ...
  var q,
    ht = ((q = ElementState.prototype).isDifferent = function isDifferent(t) {
      var e = this.bounds,
        i = t.bounds;
      ...
      s.uncache = 1, n.getProp = a, n.element = r, n.id = function _getID(t) {
      ...
      }(n, st[e] || ba(e)), n.ctm = r.getCTM && "svg" === r.nodeName.toLowerCase() && z(r).inverse(), n.simple = i || 1 === W(h.a) && !W(h.b) && !W(h.c) && 1 === W(h.d), n.uncache = 0;
    }, ElementState);
  function ElementState(t, e, i) {
    this.element = t, this.update(e, i);
  }
  var Z,
    J = ((Z = FlipAction.prototype).getStateById = function getStateById(t) {
  ...
  var U,
    K = ((U = FlipBatch.prototype).add = function add(e) {
      ...
      for (tt = this, r.clear(), this._abs.length = this._final.length = this._run.length = 0, this.actions.forEach(function (t) {
        ...
        a && a.length && (n || r) && (e = new ut(), t.states.forEach(function (t) {
          return e.add(t);
        }), (i = e.compare(pt.getState(a))).enter.length && n && n(i.enter), i.leave.length && r && r(i.leave));
  ...
  var pt = (Flip.getState = function getState(t, e) {
    var i = ua(t, e);
    ...
    }), a && ja(d, f), n = ot(d, f, s || c, !n.duration && l, c, n.duration || o ? n : 0), "object" == typeof i && "zIndex" in i && (n.zIndex = i.zIndex), g && !o && g.add(function () {
      return function () {
        return ga(d);
      };
